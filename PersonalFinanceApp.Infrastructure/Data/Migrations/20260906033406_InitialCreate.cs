    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_transaction_tags", x => new { x.TagsId, x.TransactionsId });
                    table.ForeignKey(
                        name: "FK_transaction_tags_tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_transaction_tags_transactions_TransactionsId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "00000000-0000-0000-0000-000000000001", 0, "f72408fd-6006-4cd8-8ce3-e34c42c6a3f9", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "USD", "admin@example.com", true, "System", true, "Admin", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAIAAYagAAAAEJqMnnZQkjVdnMLhJYvR83GrrwZW12KF6ikdfHShxEkC4g0xzvPJqXrvmAWk8xgilg==", null, false, "A70E28B0-8CAE-4DEE-BE39-C79178E89086", false, "admin@example.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_transaction_tags_TransactionsId",
